        ...
        <div className={s.skillsWrapper} id={'skills'}>
            ...
            <div className={s.wrapper}>
                ...
                <div className={s.skills}>
                    ...
                    <Skill title={'CSS'} description={'SASS, BEM, adaptive layout, Bootstrap, Material UI'}
                           style={cssIcon}/>
                    ...
                    {show ? <>
                            <Skill title={'WEB-Design'}
                                   description={'Creating a mobile version of the project'} style={webIcon}/>
                            ...
                            <Skill title={'Figma'} description={'Layout accordinh to the layout of the site'}
                                   style={figmaIcon}/>
